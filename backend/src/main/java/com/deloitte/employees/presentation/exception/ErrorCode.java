package com.deloitte.employees.presentation.exception;
...
public enum ErrorCode {
    ...
    UNAUTHORIZED("ERR_106", "Unauthorized", HttpStatus.UNAUTHORIZED),
    FORBIDDEN("ERR_107", "FORBIDDEN", HttpStatus.FORBIDDEN);
